...
CREATE TABLE CustomerOrderBoxLine
  (
...
ALTER TABLE CustomerOrderBoxLine ADD CONSTRAINT COBL_Box_FK FOREIGN KEY ( Box_boxID ) REFERENCES Box ( boxID ) ;

ALTER TABLE CustomerOrderBoxLine ADD CONSTRAINT COBL_CustomerOrder_FK FOREIGN KEY ( CustomerOrder_orderID ) REFERENCES CustomerOrder ( orderID ) ;
...
ALTER TABLE PaymentDetails ADD CONSTRAINT PD_Customer_FK FOREIGN KEY ( Customer_customerID ) REFERENCES Customer ( customerID ) ;
...
ALTER TABLE WarehouseLocation ADD CONSTRAINT WL_Product_FK FOREIGN KEY ( Product_productID ) REFERENCES Product ( productID ) ;
